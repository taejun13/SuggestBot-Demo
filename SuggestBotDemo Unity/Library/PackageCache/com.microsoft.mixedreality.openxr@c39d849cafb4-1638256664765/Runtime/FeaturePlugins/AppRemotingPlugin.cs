...
namespace Microsoft.MixedReality.OpenXR.Remoting
{
    ...
    internal class AppRemotingPlugin : OpenXRFeaturePlugin<AppRemotingPlugin>
    {
        ...
        {
            return false;   // Do not quit app when XR session is ended;
        }

        private bool OpenXRRuntime_wantsToRestart()
        {
            return false;  // Do not attempt to restart XR session in remoting.
        }
        ...
        protected override void OnInstanceDestroy(ulong instance)
        {
            ...
            Debug.Log($"[AppRemotingPlugin] OnInstanceDestroy, remotingState = {m_remotingState}.");
